...
7. Rodada de um gate é DERIVADA (max da série + 1), nunca escolhida por você, e só abre a seguinte quando a anterior está registrada como `reprovado` — nunca tente "ajustar" o número para destravar uma escrita bloqueada.
